package com.developerscoffee.myapp.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("StoreSampleApplication");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("StoreSampleApplication");
        ...
        config.getMapConfigs().put("com.developerscoffee.myapp.domain.*", initializeDomainMapConfig(jHipsterProperties));
